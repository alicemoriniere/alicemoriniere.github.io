<template>
  ...
  <div class="flex m-10">
    ...
    <div class="flex flex-col w-5/8 px-5">
      ...
      >
<span>
       Sur ce site, vous pourrez notamment trouver des documents relatifs à mes enseignements à l'Université de Rennes, en particulier pour les TP de prépa agreg en option A, des documents en lien avec l'agrégation (que j'ai passé en 2024) et divers mémoires de stages rédigés au cours de ma scolarité. </span
      >
