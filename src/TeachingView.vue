...
<span> J'ajouterai au fur et à mesure de l'année mes corrections et récaps de TP. </span>
   <span class="text-2xl my-3 bold"> Enoncés et corrections des TP :</span>
    ...
    <div class="grid grid-cols-8 gap-x-5 gap-y-5 mt-1">
      ...
      <span>
        <a href="tp/tp2Python.pdf" target="_blank" class="underline"> TP n°2 </a>  </span>
      <span>
        <a href="tp/tp3Python.pdf" target="_blank" class="underline"> TP n°3 </a>  </span>
      <span>
        <a href="tp/tp4Python.pdf" target="_blank" class="underline"> TP n°4 </a>  </span>
      <span>
        <a href="tp/tp5Python.pdf" target="_blank" class="underline"> TP n°5 </a>  </span>
      <span>
        <a href="tp/tp6Python.pdf" target="_blank" class="underline"> TP n°6 </a>  </span>
      <span>
        <a href="tp/tp7Python.pdf" target="_blank" class="underline"> TP n°7 </a>  </span>
      <span>
