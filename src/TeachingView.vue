<template>
  <div class="flex flex-col justify-start">
    ...
    <div class="grid grid-cols-9 gap-x-5 gap-y-5 mt-1">
      ...
      <span> <a href="tp/tp5Python.pdf" target="_blank" class="underline"> TP n°5 </a> </span>
    ...
    <div class="grid grid-cols-1 gap-x-5 gap-y-5 mt-1">
      ...
      <span>
        TP n°6 :
        <a href="tp/donnees6.1.csv" target="_blank" class="underline"> données x (unif)</a>,
        <a href="tp/donnees6.2.csv" target="_blank" class="underline"> données x (gaussienne)</a>,
        <a href="tp/donnees6.3.csv" target="_blank" class="underline"> données y</a>,
        <a href="tp/donnees6.4.csv" target="_blank" class="underline"> données z</a> et
